  ...
  function ($parse, $window, $timeout) {
    return {
      ...
      link: function (scope, element, attrs) {
        ...
        var documentBody = angular.element(document.body), scrollRatio;
        var container = element, wrapper = angular.element(element.children()[0]), content = angular.element(wrapper.children()[0]), bar = wrapper.next();
        var touchEndTimeout;
        ...
        function moveBar() {
          var totalHeight = content[0].scrollHeight, ownHeight = container[0].clientHeight, barMinHeight = scope.scrollerMinHeight;
          scrollRatio = ownHeight / totalHeight;
          var actualScrollRatio = barMinHeight || scrollRatio;
          var scrollPct = barMinHeight / ownHeight * 100;
      ...
      template: '<div class="ss-container" ng-class="{\'show-scroll\': showYScrollbar}">         <div class="ss-wrapper">           <div class="ss-content" ng-transclude>           </div>         </div>         <div class="ss-scroll"></div>       </div>'
    };
  }
]);